    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_add_Products">
                                <i class="ki-duotone ki-plus "></i>Add PRODUCTS</button>
                            <!--end::Primary button-->
                        </div>
                        <!--end::Actions-->
                    </div>
                ...
                <div class="modal fade" id="kt_modal_add_Products" tabindex="-1" aria-hidden="true">
                    <!--begin::Modal dialog-->
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <!--begin::Modal content-->
                        <div class="modal-content">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_Products_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">ADD PRODUCTS</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal"
                                    data-kt-Productss-modal-action="close">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                {{-- <form id="kt_modal_add_Products_form" class="form" action="#"> --}}
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_Products_scroll"
                                    data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                                    data-kt-scroll-max-height="auto"
                                    data-kt-scroll-dependencies="#kt_modal_add_Products_header"
                                    data-kt-scroll-wrappers="#kt_modal_add_Products_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="text-center pt-15">
                                    <button type="reset" class="btn btn-light me-3"
                                        data-kt-Products-modal-action="cancel">Discard</button>
                ...
                @foreach ($data as $key => $products)
                    ...
                    <div class="modal fade" id="kt_modal_edit_products{{ $products->id }}" tabindex="-1"
                        aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            <!--begin::Modal content-->
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            {!! Form::text('image', $products->image, [
                                                'placeholder' => 'IMAGE',
                                                'class' => 'form-control form-control-solid mb-3 mb-lg-0',
                                            ]) !!}
                                            <!--end::Input-->
                ...
                @foreach ($data as $key => $products)
                    <!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++begin::Modal - ShowProducts-->
                    <div class="modal fade" id="kt_modal_show_products{{ $products->id }}" tabindex="-1"
                        aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            <!--begin::Modal content-->
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_products_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bold">DETAIL PRODUCTS</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal"
                                        data-kt-productss-modal-action="close">
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-w-125px sorting">Price</th>
                                                <th class="min-w-125px sorting">Description</th>
                                                <th class="min-w-125px sorting">Image</th>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $products)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('products.show', $products->id) }}"
                                                            class="text-gray-800 text-hover-primary mb-1">{{ Str::limit($products->name, 25) }}</a>
                                                    </td>
                                                    <td><a href="{{ route('products.show', $products->id) }}"
                                                            class="text-gray-800 text-hover-primary mb-1">{{ Str::limit($products->price, 25) }}</a>
                                                    </td>
                                                    <td><a href="{{ route('products.show', $products->id) }}"
                                                            class="text-gray-800 text-hover-primary mb-1">{{ Str::limit($products->description, 25) }}</a>
                                                    </td>
                                                            ...
                                                            <a href="{{ route('products.show', $products->id) }}">
                                                                <div class="symbol-label">
                                                                    @if (!empty($products->image))
                                                                        <img src="{{ url('images') }}/products/{{ $products->image }}"
                                                                            alt="Emma Smith" class="w-100" />
                                                                    @else
                                                                        <img src="{{ url('images') }}/imagenotavailable.jpg"
                                                                            alt="Emma Smith" class="w-100" />
                                                                    @endif
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a class="menu-link px-3" data-bs-toggle="modal"
                                                                    data-bs-target="#kt_modal_show_products{{ $products->id }}">Show</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a class="menu-link px-3" data-bs-toggle="modal"
                                                                    data-bs-target="#kt_modal_edit_products{{ $products->id }}">Edit</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                ...
                                                                <a onclick="document.getElementById('form-id').submit();"
                                                                    ...
                                                                    data-kt-productss-table-filter="delete_row"> Delete</a>
                                                                {!! Form::close() !!}
